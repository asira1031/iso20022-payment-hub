  ...
  return (
    ...
    >
      <section style={{ maxWidth: "1400px", margin: "0 auto" }}>
        ...
        <p style={{ marginTop: 12, color: "#cbd5e1", fontSize: 18, maxWidth: 850, lineHeight: 1.8 }}>
          Manage merchant QR codes, payment acceptance, transaction monitoring,
          provider routing, and settlement readiness.
        </p>

        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(250px,1fr))", gap: 20, marginTop: 35 }}>
          <Card title="QR Codes" value="0" />
          <Card title="Payments Today" value="0" />
          <Card title="Volume Today" value="₱0.00" />
          <Card title="Settlement Pending" value="₱0.00" />
        </div>

        <div style={{ marginTop: 30, display: "flex", gap: 15, flexWrap: "wrap" }}>
          <ActionButton text="Generate Merchant QR" />
          <ActionButton text="Static QR" />
          <ActionButton text="Dynamic QR" />
          <ActionButton text="Settlement Report" />
        </div>

        <Panel title="QR Acceptance Channels">
          <Grid items={["GCash Link", "Maya Business Link", "Bank QR", "Merchant QR", "In-App QR", "Settlement QR"]} />
        </Panel>

        <Panel title="QR Transaction Monitor">
          <table style={{ width: "100%", marginTop: 25, borderCollapse: "collapse" }}>
            ...
            <tbody>
              <tr>
                <td style={tdStyle}>No transactions yet</td>
                <td style={tdStyle}>-</td>
                <td style={tdStyle}>-</td>
                <td style={tdStyle}>-</td>
                <td style={tdStyle}>-</td>
