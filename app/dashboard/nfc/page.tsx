export default function NFCCenterPage() {
  return (
    <main
      style={{
        position: "fixed",
    ...
    >
      <section style={{ maxWidth: "1400px", margin: "0 auto" }}>
        ...
        <p style={{ marginTop: 12, color: "#cbd5e1", fontSize: 18, maxWidth: 900, lineHeight: 1.8 }}>
          Manage NFC acceptance, tap-to-pay readiness, tokenized transactions,
          SoftPOS compatibility, secure device enrollment, and future card-present payment flows.
        </p>

        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(250px,1fr))", gap: 20, marginTop: 35 }}>
          <Card title="NFC Devices" value="0" />
          <Card title="Tokens Issued" value="0" />
          <Card title="Tap Payments" value="0" />
          <Card title="Risk Alerts" value="0" />
        </div>

        <div style={{ marginTop: 30, display: "flex", gap: 15, flexWrap: "wrap" }}>
          <ActionButton text="Enroll NFC Device" />
          <ActionButton text="Issue Token" />
          <ActionButton text="Run Security Check" />
          <ActionButton text="View Tap Ledger" />
        </div>

        <Panel title="NFC Capabilities">
          <Grid
            items={[
              "Tap to Pay",
              "Tokenization",
        ...
        <Panel title="NFC Transaction Monitor">
          <table style={{ width: "100%", marginTop: 25, borderCollapse: "collapse" }}>
            ...
            <tbody>
              <tr>
                <td style={tdStyle}>No NFC transactions yet</td>
                <td style={tdStyle}>-</td>
                <td style={tdStyle}>-</td>
                <td style={tdStyle}>-</td>
                <td style={tdStyle}>-</td>
